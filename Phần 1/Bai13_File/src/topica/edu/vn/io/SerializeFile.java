...
public class SerializeFile {
	public static boolean luuFile(ArrayList<KhachHang2> dsKH, String path)
	{
		try {
	...
	public static ArrayList<KhachHang2> docFile (String path){
		...
		try {
			...
			dsKH = (ArrayList<KhachHang2>) data; // Ctrl + 1: gỡ lỗi 
			// Đóng file
			ois.close();
			fis.close();
		} 
