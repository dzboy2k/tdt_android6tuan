...
public class TestKhachHang {
	...
	private static void xuLyTim() {
		...
		System.out.println("Mã\tTên\tPhone");
		for (KhachHang kh : dsKH) {
			// startsWith: Kiểm tra các kí tự đầu chuỗi với chuỗi được truyền vào
	...
	private static void xuLyThoat() {
		System.out.println("Cảm ơn bạn đã dùng chương trình! Bye bye");
		System.exit(0); // Thoát chương trình thông thường
	}
